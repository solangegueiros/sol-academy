...
export const B4HHeader: React.FC = memo(() => {
  ...
  return(
    <header className="min-h-screen">
      <nav className="antialiased bg-gray-100 dark-mode:bg-gray-900">
            ...
            <div className="flex justify-between items-center">
              <div className="flex flex-row items-center justify-between p-2">
                <div className="inline-flex shadow-sm rounded-md" role="group">
                  <button type="button" className="rounded-l-lg border border-gray-200 bg-white text-xs font-medium px-2 py-1 text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                      EN
                  </button>
                  <button type="button" className="border-t border-b border-gray-200 bg-white text-xs font-medium px-2 py-1 text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                      ES
                  </button>
                  <button type="button" className="rounded-r-md border border-gray-200 bg-white text-xs font-medium px-2 py-1 text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                      PT
                  </button>
                </div>
              </div>
